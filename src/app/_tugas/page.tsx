  ...
  const DATA_PROGRESS = [
    {
      label: "Mentoring",
      currentProgress:
        progress.mentoringVlogDone && progress.mentoringReflectionDone
          ? 2
          : progress.mentoringVlogDone || progress.mentoringReflectionDone
            ? 1
            : 0,
    ...
    },
    {
      ...
      currentProgress:
        progress.firstFossibDone && progress.secondFossibDone
          ? 2
          : progress.firstFossibDone || progress.secondFossibDone
            ? 1
            : 0,
  ...
  const ASSINGMENTS: AssignmentProps[] = [
    {
      ...
      template:
        "https://docs.google.com/document/d/1Z3engQq3QwqyE2HjhTSxwxJchf2brPr7/edit",
    ...
    },
    {
      ...
      type: "pdf",
      template:
        "https://drive.google.com/drive/folders/1nai7H4PCZplp8qaP7VFqF90TEOwnWSly",
    },
    {
      id: "fossib-2",
      name: "Fossib: TTS",
      description:
        "Setelah sharing insight, maba dan kakak asuh melakukan kegiatan bersama untuk dapat saling mendekatkan diri.",
      deadline: new Date(2024, 7, 29),
      icon: <HiOutlineUsers />,
    ...
    },
    {
      ...
      description:
        "Maba bersama teman satu kelompok networking menjalin relasi dengan kakak tingkat KMBUI angkatan 2023.",
      deadline: new Date(2024, 7, 31),
      icon: <HiOutlineChatAlt2 />,
      isFinished:
        progress.networkingKating["2023"].progres >=
        progress.networkingKating["2023"].min,
      namingFormat: "[Nama Lengkap]_[Fakultas]_Networking2023_[nomor].pdf",
      type: "pdf",
      template:
        "https://docs.google.com/document/d/1lZgM33u7c1GUpFVZYDBeZWrPQjzvaDyPwwJYrnz-VB4/edit",
    },
    {
      id: "networking-2022",
      name: "Networking Kating 2022",
      description:
        "Maba bersama teman satu kelompok networking menjalin relasi dengan kakak tingkat KMBUI angkatan 2022.",
      deadline: new Date(2024, 7, 31),
      icon: <HiOutlineChatAlt2 />,
      isFinished:
        progress.networkingKating["2022"].progres >=
        progress.networkingKating["2022"].min,
    ...
    },
    {
      ...
      description:
        "Maba bersama teman satu kelompok networking menjalin relasi dengan kakak tingkat KMBUI angkatan 2021.",
      deadline: new Date(2024, 7, 31),
      icon: <HiOutlineChatAlt2 />,
      isFinished:
        progress.networkingKating["2021"].progres >=
        progress.networkingKating["2021"].min,
    ...
    },
    {
      ...
      description:
        "Setelah tiap sesi mentoring, maba diharapkan dapat menulis rangkuman intisari dari kegiatan yang dilakukan sesuai kreativitas masing-masing.",
      ...
      type: "pdf",
      template:
        "https://www.canva.com/design/DAGKvoTzibg/xWWM0zwn6hPYRy5qN0hX6A/view?utm_content=DAGKvoTzibg&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink&mode=preview",
    },
    {
      id: "mentoring-v",
      name: "Mentoring: Vlog",
    ...
    },
    {
      ...
      name: "KMBUI Explorer",
      description:
        "Maba mengikuti paling sedikit 2 proker yang diadakan oleh KMBUI agar lebih mengenali KMBUI dan nilai-nilai Buddhis.",
      ...
      type: "pdf",
      template:
        "https://drive.google.com/file/d/1YlWD1fHyxUPzCd0f2qRbHaOKNBvelWol/view",
    },
  ];
